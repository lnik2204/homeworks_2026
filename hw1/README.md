...
| `test_sequences.fna` | Последовательности для проверки работы кода для задания №6 |
...
В .github/workflows я положила файл HW1-WF.yaml для тестирования моего кода. Был написан
воркфлоу, который делает чекаут моего репозитория, устанавливает питон, а затем
проверяет, что скрипты из задания 2 и 3 не падают.

На первых тестах скрипты падали, но ошибки были устранены. Потом тест прошел, но защитить ветку main от непрошедших слияний не удалось полностью, GitHub не дал выбрать воркфлоу

## Структура репозитория после первого дз
<img width="194" height="159" alt="Снимок экрана 2026-03-18 в 22 40 53" src="https://github.com/user-attachments/assets/54dc3158-4eaf-4a90-ae49-aea9e868fb2c" />
